            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                  ...
                  ADMINISTRACAO DE FUNDOS E CORRESPONDENTE BANCARIO LTDA
                        ...
                        <span v-if="proponente.cedula_identidade">Cédula de Identidade: {{proponente.cedula_identidade}}</span>
                         e inscrito no CPF número {{proponente.cpf}} , residente em {{proponente.logradouro}}, n° {{proponente.numero}}, 
                         bairro: {{proponente.bairro}} - Cidade: {{proponente.cidade}}, Estado {{proponente.estado}} - CEP: {{proponente.cep}},complemento:
                        {{proponente.complemento}}, telefones: {{proponente.celular}} - {{proponente.telefone}}, E-mail: {{proponente.email}}, doravante denominada <span class="font-weight-bold">APORTADOR</span>, sendo assim, firma- se o presente CONTRATO
                        DE CESSÃO DE QUOTAS DO PROJETO “{{proponente.projetos}}”, conforme as cláusulas a seguir:
                        <br>
                        <br>
                        <span class="font-weight-bold">Cláusula 1ª – Do Objeto do Contrato</span>
                        <br>Por meio deste contrato, que firmam entre si os
                        <span class="font-weight-bold">ADMINISTRADORES</span> e o <span class="font-weight-bold">APORTADOR</span>, regula–se a transferência de R${{proponente.valor_aporte}} ({{valor_extenso}}) quotas de titularidade dos Administradores.
                        <br>
                        <br>§ 1º O
                        ...
                        o valor certo de R${{proponente.valor_aporte}} ({{valor_extenso}}), 
